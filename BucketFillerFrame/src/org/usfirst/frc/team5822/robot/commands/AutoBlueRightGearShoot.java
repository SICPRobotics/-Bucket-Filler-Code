...
public class AutoBlueRightGearShoot extends CommandGroup
{
	public AutoBlueRightGearShoot()
	{
      //  addSequential(new DriveForward(1)); //input is encoder distance until start line up
        addSequential(new TurnLeftFast(-60)); //input is angle we want to turn
        addSequential(new TurnRightSlow(-60)); //have to figure out distance
...
//		addSequential(new TurnLeftFast(-45));
//		addSequential(new TurnRightSlow(-45));
